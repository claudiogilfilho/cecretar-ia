...
| Mídias reais na biblioteca | `Pode me enviar fotos das salas?` após o carregamento de 11 imagens e 2 áudios. | O simulador reconheceu o pedido e retornou a resposta de apresentação. A caixa de entrada registrou explicitamente `Mídia vinculada: fotos_salas`, confirmando a seleção da intenção abastecida com as imagens reais. O envio de binários reais por WhatsApp permanece condicionado à ativação do canal de teste. | Aprovado no simulador |
